...
- [x] 2. Implement Storage utility and global error banner
  ...
  - [x] 2.3 Implement the `localStorage` unavailability banner
...
- [x] 3. Implement ThemeManager
  - [x] 3.1 Implement `ThemeManager` in `app.js`
  ...
  - [x] 3.2 Add CSS custom properties and theme switching to `style.css`
...
- [x] 4. Implement GreetingWidget
  ...
  - [x] 4.2 Implement `GreetingWidget.getGreeting(hour)` pure function
  ...
  - [x] 4.4 Implement `GreetingWidget.tick()`, `GreetingWidget.renderUserName()`, and `GreetingWidget.setUserName(name)`
  ...
  - [x] 4.5 Implement `GreetingWidget.init()`
...
- [x] 5. Checkpoint — Greeting and theme working end-to-end
...
- [x] 6. Implement TimerWidget
  ...
  - [x] 6.2 Implement `TimerWidget.formatTime(secs)` pure function
  ...
  - [x] 6.4 Implement `TimerWidget` state and controls
...
- [x] 7. Implement TodoWidget
  ...
  - [x] 7.2 Implement `TodoWidget.isDuplicate(text)` pure function
  ...
  - [x] 7.4 Implement `TodoWidget.addTask(text)`, `editTask(index, newText)`, `toggleComplete(index)`, `deleteTask(index)`, and `saveTasks()`
  ...
  - [x] 7.7 Implement `TodoWidget.getSortedTasks()` and `setSort(option)`
  ...
  - [x] 7.10 Implement `TodoWidget.render()` and `TodoWidget.init()`
...
- [x] 8. Checkpoint — Timer and To-Do list working end-to-end
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. Implement LinkWidget
  ...
  - [x] 9.2 Implement `LinkWidget.validateUrl(url)` pure function
  ...
  - [x] 9.4 Implement `LinkWidget.addLink(label, url)`, `deleteLink(index)`, `saveLinks()`, and `render()`
  ...
  - [x] 9.6 Implement `LinkWidget.init()`
...
- [x] 10. Wire initialization sequence and finalize `app.js`
  - [x] 10.1 Wire the full initialization order inside `DOMContentLoaded`
  ...
  - [x] 10.2 Add accessibility attributes throughout `index.html`
